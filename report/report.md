...
**Method:** SDS with `guidance_scale = 25` (fixed per assignment); latent initialized as random Gaussian noise, 500 optimization steps.  
**Evaluation:** CLIP ViT-B/32 (`eval.py`), scored against each **prompt**.  
**Overall CLIP score:** **0.301**
...
### 1. A red bus driving on a desert road

**CLIP:** 0.368

![Generated](../outputs/sds/A_red_bus_driving_on_a_desert_road.png)

### 2. a boat in a river

**CLIP:** 0.280

![Generated](../outputs/sds/a_boat_in_a_river.png)

### 3. A cabin surrounded by forests

**CLIP:** 0.285

![Generated](../outputs/sds/A_cabin_surrounded_by_forests.png)

### 4. A church beside a lake

**CLIP:** 0.343

![Generated](../outputs/sds/A_church_beside_a_lake.png)

### 5. A villa close to the pool

**CLIP:** 0.284

![Generated](../outputs/sds/A_villa_close_to_the_pool.png)

### 6. A castle next to a river

**CLIP:** 0.285

![Generated](../outputs/sds/A_castle_next_to_a_river.png)

### 7. A burger on the table

**CLIP:** 0.283

![Generated](../outputs/sds/A_burger_on_the_table.png)

### 8. A dog sitting on grass

**CLIP:** 0.297

![Generated](../outputs/sds/A_dog_sitting_on_grass.png)

### 9. a cat sitting on a table

**CLIP:** 0.288

![Generated](../outputs/sds/a_cat_sitting_on_a_table.png)

### 10. A car on the road

**CLIP:** 0.297

![Generated](../outputs/sds/A_car_on_the_road.png)
